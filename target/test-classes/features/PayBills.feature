...
Feature: Pay Bills
  ...
  Scenario: Add New Bill Name and Pay a bill through mobile recharge
    ...
    When The user clicks on the pay a new bill button
		...
		And The user clicks on the "Pay In Full" as the payment option
		When The user enters the Mobile Number
		When The user enters the Beneficiary name
		And The proceed to the next step
		And The user clicks on the "Pay In Full" as the payment option and Accept Terms & Conditions
